...
namespace GroundStationDrone
{
    class AirSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(GroundStationDrone.Properties.Resources.AirSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(GroundStationDrone.Properties.Resources.AirSpeedNeedle);
