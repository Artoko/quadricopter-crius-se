...
namespace GroundStationDrone
{
    class HeadingIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(GroundStationDrone.Properties.Resources.HeadingIndicator_Background);
        Bitmap bmpHedingWeel = new Bitmap(GroundStationDrone.Properties.Resources.HeadingWeel);
        Bitmap bmpAircaft = new Bitmap(GroundStationDrone.Properties.Resources.HeadingIndicator_Aircraft);        
