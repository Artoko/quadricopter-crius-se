...
namespace GroundStationDrone
{
    class AltimeterInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(GroundStationDrone.Properties.Resources.Altimeter_Background);
        Bitmap bmpSmallNeedle = new Bitmap(GroundStationDrone.Properties.Resources.SmallNeedleAltimeter);
        Bitmap bmpLongNeedle = new Bitmap(GroundStationDrone.Properties.Resources.LongNeedleAltimeter);
        Bitmap bmpScroll = new Bitmap(GroundStationDrone.Properties.Resources.Bandeau_Dérouleur);
