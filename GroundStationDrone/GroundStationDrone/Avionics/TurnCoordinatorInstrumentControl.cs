...
namespace GroundStationDrone
{
    class TurnCoordinatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(GroundStationDrone.Properties.Resources.TurnCoordinator_Background);
        Bitmap bmpBall = new Bitmap(GroundStationDrone.Properties.Resources.TurnCoordinatorBall);
        Bitmap bmpAircraft = new Bitmap(GroundStationDrone.Properties.Resources.TurnCoordinatorAircraft);
        Bitmap bmpMarks = new Bitmap(GroundStationDrone.Properties.Resources.TurnCoordinatorMarks);
