...
namespace GroundStationDrone
{
    class VerticalSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(GroundStationDrone.Properties.Resources.VerticalSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(GroundStationDrone.Properties.Resources.VerticalSpeedNeedle);
