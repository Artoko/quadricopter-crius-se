...
namespace GroundStationDrone
{
    class AttitudeIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(GroundStationDrone.Properties.Resources.Horizon_Background);
        Bitmap bmpBoule = new Bitmap(GroundStationDrone.Properties.Resources.Horizon_GroundSky);
        Bitmap bmpAvion = new Bitmap(GroundStationDrone.Properties.Resources.Maquette_Avion);
